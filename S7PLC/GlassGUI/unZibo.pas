...
procedure TfrmZibo.DrawAirDesk(areaNo: byte; Sx, Sy, xLength, yLength, xHole, yHole, radial, direction, vOffset : integer; zoom :word=100);
var
  iType, iState: UINT;
  iRect: TRect;
...
procedure TfrmZibo.DrawRectangleStacker(areaNo: byte; Cx, Cy, Rlength, Rwidth, direction, vOffset :word; borderColor, fillColor :TColor);
var
...
procedure TfrmZibo.DrawRotationStacker(areaNo: byte; Cx, Cy, Rlength, Rwidth, direction, vOffset :word; borderColor, fillColor :TColor);
var
...
procedure TfrmZibo.FormCreate(Sender: TObject);
begin
...
procedure TfrmZibo.DrawRotator(areaNo: byte; Cx, Cy, Rlength, Rwidth, direction,vOffset :word; borderColor, fillColor :TColor);
const
...
procedure TfrmZibo.DrawLabel(Sx, Sy, lineLength, direction :integer; posNo :string);
var
  i: byte;
  iType, iState: UINT;
  iRect: TRect;
...
procedure TfrmZibo.DrawSideLine(areaNo: byte; Sx, Sy, Rlength, Rwidth, L1, W1, L2, W2, Rratio, vOffset, top, direction :word; posLabel: string; borderColor, fillColor :TColor);
var
  iRect :TRect ;
...
procedure TfrmZibo.DrawSnap(areaNo :byte; Sx, Sy, Rlength : word; borderColor, fillColor: TColor);
var
...
procedure TfrmZibo.BitBtn12Click(Sender: TObject);
begin
...
procedure TfrmZibo.BitBtn13Click(Sender: TObject);
begin
  Canvas.Brush.Color := clWhite;
...
procedure TfrmZibo.BitBtn14Click(Sender: TObject);
var
  bmp :TBitMap ;
  cvs :TCanvas;
begin
...
procedure TfrmZibo.DrawChevron(Sx, Sy, Rlength, Rwidth, Rratio: word;
  borderColor, fillColor: TColor; Shorizon: boolean);
var
...
procedure TfrmZibo.DrawEdgeTrim(Sx: word; Sy: word; Rlength: word;
...
procedure TfrmZibo.DrawRoller(Sx, Sy, Slength, Swidth, Sratio,
...
procedure TfrmZibo.BitBtn10Click(Sender: TObject);
begin
  Canvas.Brush.Color := clWhite;
  Canvas.FillRect(Rect(0, 0, self.width - 1, self.height - 1));
...
procedure TfrmZibo.DrawPositonRect(areaNo: byte);
var
...
procedure TfrmZibo.DrawConnection(areaNo: byte);
var
  i: integer;
  iType, iState: UINT;
...
procedure TfrmZibo.DrawLine(Sx, Sy, Ex, Ey: word; CurColor: TColor);
begin
...
procedure TfrmZibo.DrawRect(Sx, Sy, Ex, Ey: word; borderColor: TColor;
  fillColor: TColor = clWhite);
begin
  Canvas.Pen.Color := borderColor;
  Canvas.Brush.Color := fillColor;
...
procedure TfrmZibo.DrawArrow(Sx, Sy: word; sizeLength: word; direction: byte);
var
  Ex, Ey: word;
  X1, Y1, X2, Y2: word;
begin
...
procedure TfrmZibo.DrawArrow(Sx, Sy: word; sizeLength, sizeWidth: word; direction: byte);
var
  Ex, Ey: word;
...
procedure TfrmZibo.BitBtn2Click(Sender: TObject);
begin
...
procedure TfrmZibo.DrawArea(areaNo: byte);
var
  i: word;
begin
...
procedure TfrmZibo.BitBtn1Click(Sender: TObject);
var
