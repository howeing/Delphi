...
procedure TfrmTengzhou.DrawStacker(Cx, Cy, Rlength, Rwidth, direction, vOffset :word; borderColor, fillColor :TColor);
var
...
procedure TfrmTengzhou.DrawRotator(Cx, Cy, Rlength, Rwidth, direction,vOffset :word; borderColor, fillColor :TColor);
var
  i, vSx, vSy, vEx, vEy, vSize, vRadio :integer;
begin
...
procedure TfrmTengzhou.DrawSideLine(Sx, Sy, Rlength, Rwidth, L1, W1, L2, W2, Rratio, vOffset, top, direction :word; borderColor, fillColor :TColor);
var
  iRect :TRect ;
