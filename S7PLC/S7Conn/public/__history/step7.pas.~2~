...
//                                S7 CONVERSION CLASS
//******************************************************************************
  TS7Type = (S7Bool, S7Int, S7DInt, S7Word, S7DWord, S7Real, S7DT_To_DateTime, DateTime_To_S7DT);
...
//                               CLIENT FORWARDS
//******************************************************************************
function Cli_Create;                  external simatic_lib name 'Cli_Create';
procedure Cli_Destroy;                external simatic_lib name 'Cli_Destroy';
function Cli_ConnectTo;               external simatic_lib name 'Cli_ConnectTo';
function Cli_SetConnectionParams;     external simatic_lib name 'Cli_SetConnectionParams';
function Cli_SetConnectionType;       external simatic_lib name 'Cli_SetConnectionType';
function Cli_Disconnect;              external simatic_lib name 'Cli_Disconnect';
function Cli_Connect;                 external simatic_lib name 'Cli_Connect';
function Cli_GetParam;                external simatic_lib name 'Cli_GetParam';
function Cli_SetParam;                external simatic_lib name 'Cli_SetParam';
function Cli_SetAsCallback;           external simatic_lib name 'Cli_SetAsCallback';
function Cli_ReadArea;                external simatic_lib name 'Cli_ReadArea';
function Cli_WriteArea;               external simatic_lib name 'Cli_WriteArea';
function Cli_ReadMultiVars;           external simatic_lib name 'Cli_ReadMultiVars';
function Cli_WriteMultiVars;          external simatic_lib name 'Cli_WriteMultiVars';
function Cli_DBRead;                  external simatic_lib name 'Cli_DBRead';
function Cli_DBWrite;                 external simatic_lib name 'Cli_DBWrite';
function Cli_MBRead;                  external simatic_lib name 'Cli_MBRead';
function Cli_MBWrite;                 external simatic_lib name 'Cli_MBWrite';
function Cli_EBRead;                  external simatic_lib name 'Cli_EBRead';
function Cli_EBWrite;                 external simatic_lib name 'Cli_EBWrite';
function Cli_ABRead;                  external simatic_lib name 'Cli_ABRead';
function Cli_ABWrite;                 external simatic_lib name 'Cli_ABWrite';
function Cli_TMRead;                  external simatic_lib name 'Cli_TMRead';
function Cli_TMWrite;                 external simatic_lib name 'Cli_TMWrite';
function Cli_CTRead;                  external simatic_lib name 'Cli_CTRead';
function Cli_CTWrite;                 external simatic_lib name 'Cli_CTWrite';
function Cli_ListBlocks;              external simatic_lib name 'Cli_ListBlocks';
function Cli_GetAgBlockInfo;          external simatic_lib name 'Cli_GetAgBlockInfo';
function Cli_GetPgBlockInfo;          external simatic_lib name 'Cli_GetPgBlockInfo';
function Cli_ListBlocksOfType;        external simatic_lib name 'Cli_ListBlocksOfType';
function Cli_Upload;                  external simatic_lib name 'Cli_Upload';
function Cli_FullUpload;              external simatic_lib name 'Cli_FullUpload';
function Cli_Download;                external simatic_lib name 'Cli_Download';
function Cli_Delete;                  external simatic_lib name 'Cli_Delete';
function Cli_GetPlcDateTime;          external simatic_lib name 'Cli_GetPlcDateTime';
function Cli_SetPlcDateTime;          external simatic_lib name 'Cli_SetPlcDateTime';
function Cli_SetPlcSystemDateTime;    external simatic_lib name 'Cli_SetPlcSystemDateTime';
function Cli_GetOrderCode;            external simatic_lib name 'Cli_GetOrderCode';
function Cli_GetCpuInfo;              external simatic_lib name 'Cli_GetCpuInfo';
function Cli_GetCPInfo;               external simatic_lib name 'Cli_GetCpInfo';
function Cli_ReadSZL;                 external simatic_lib name 'Cli_ReadSZL';
function Cli_ReadSZLList;             external simatic_lib name 'Cli_ReadSZLList';
function Cli_PlcHotStart;             external simatic_lib name 'Cli_PlcHotStart';
function Cli_PlcColdStart;            external simatic_lib name 'Cli_PlcColdStart';
function Cli_PlcStop;                 external simatic_lib name 'Cli_PlcStop';
function Cli_CopyRamToRom;            external simatic_lib name 'Cli_CopyRamToRom';
function Cli_Compress;                external simatic_lib name 'Cli_Compress';
function Cli_GetPlcStatus;            external simatic_lib name 'Cli_GetPlcStatus';
function Cli_GetProtection;           external simatic_lib name 'Cli_GetProtection';
function Cli_SetSessionPassword;      external simatic_lib name 'Cli_SetSessionPassword';
function Cli_ClearSessionPassword;    external simatic_lib name 'Cli_ClearSessionPassword';
function Cli_DBGet;                   external simatic_lib name 'Cli_DBGet';
function Cli_DBFill;                  external simatic_lib name 'Cli_DBFill';
function Cli_GetExecTime;             external simatic_lib name 'Cli_GetExecTime';
function Cli_GetPduLength;            external simatic_lib name 'Cli_GetPduLength';
function Cli_GetLastError;            external simatic_lib name 'Cli_GetLastError';
function Cli_AsReadArea;              external simatic_lib name 'Cli_AsReadArea';
function Cli_AsWriteArea;             external simatic_lib name 'Cli_AsWriteArea';
function Cli_AsDBRead;                external simatic_lib name 'Cli_AsDBRead';
function Cli_AsDBWrite;               external simatic_lib name 'Cli_AsDBWrite';
function Cli_AsMBRead;                external simatic_lib name 'Cli_AsMBRead';
function Cli_AsMBWrite;               external simatic_lib name 'Cli_AsMBWrite';
function Cli_AsEBRead;                external simatic_lib name 'Cli_AsEBRead';
function Cli_AsEBWrite;               external simatic_lib name 'Cli_AsEBWrite';
function Cli_AsABRead;                external simatic_lib name 'Cli_AsABRead';
function Cli_AsABWrite;               external simatic_lib name 'Cli_AsABWrite';
function Cli_AsTMRead;                external simatic_lib name 'Cli_AsTMRead';
function Cli_AsTMWrite;               external simatic_lib name 'Cli_AsTMWrite';
function Cli_AsCTRead;                external simatic_lib name 'Cli_AsCTRead';
function Cli_AsCTWrite;               external simatic_lib name 'Cli_AsCTWrite';
function Cli_AsListBlocksOfType;      external simatic_lib name 'Cli_AsListBlocksOfType';
function Cli_AsReadSZL;               external simatic_lib name 'Cli_AsReadSZL';
function Cli_AsReadSZLList;           external simatic_lib name 'Cli_AsReadSZLList';
function Cli_AsUpload;                external simatic_lib name 'Cli_AsUpload';
function Cli_AsFullUpload;            external simatic_lib name 'Cli_AsFullUpload';
function Cli_AsDownload;              external simatic_lib name 'Cli_AsDownload';
function Cli_AsCopyRamToRom;          external simatic_lib name 'Cli_AsCopyRamToRom';
function Cli_AsCompress;              external simatic_lib name 'Cli_AsCompress';
function Cli_AsDBGet;                 external simatic_lib name 'Cli_AsDBGet';
function Cli_AsDBFill;                external simatic_lib name 'Cli_AsDBFill';
function Cli_CheckAsCompletion;       external simatic_lib name 'Cli_CheckAsCompletion';
function Cli_WaitAsCompletion;        external simatic_lib name 'Cli_WaitAsCompletion';
function Cli_IsoExchangeBuffer;       external simatic_lib name 'Cli_IsoExchangeBuffer';
function Cli_ErrorText;               external simatic_lib name 'Cli_ErrorText';
function Cli_GetConnected;            external simatic_lib name 'Cli_GetConnected';
//******************************************************************************
//                               SERVER FORWARDS
//******************************************************************************
function Srv_Create;                  external simatic_lib name 'Srv_Create';
procedure Srv_Destroy;                external simatic_lib name 'Srv_Destroy';
function Srv_GetParam;                external simatic_lib name 'Srv_GetParam';
function Srv_SetParam;                external simatic_lib name 'Srv_SetParam';
function Srv_Start;                   external simatic_lib name 'Srv_Start';
function Srv_StartTo;                 external simatic_lib name 'Srv_StartTo';
function Srv_Stop;                    external simatic_lib name 'Srv_Stop';
function Srv_RegisterArea;            external simatic_lib name 'Srv_RegisterArea';
function Srv_UnregisterArea;          external simatic_lib name 'Srv_UnregisterArea';
function Srv_LockArea;                external simatic_lib name 'Srv_LockArea';
function Srv_UnlockArea;              external simatic_lib name 'Srv_UnlockArea';
function Srv_GetStatus;               external simatic_lib name 'Srv_GetStatus';
function Srv_SetCpuStatus;            external simatic_lib name 'Srv_SetCpuStatus';
function Srv_PickEvent;               external simatic_lib name 'Srv_PickEvent';
function Srv_ClearEvents;             external simatic_lib name 'Srv_ClearEvents';
function Srv_GetMask;                 external simatic_lib name 'Srv_GetMask';
function Srv_SetMask;                 external simatic_lib name 'Srv_SetMask';
function Srv_SetEventsCallback;       external simatic_lib name 'Srv_SetEventsCallback';
function Srv_SetReadEventsCallback;   external simatic_lib name 'Srv_SetReadEventsCallback';
function Srv_SetRWAreaCallback;       external simatic_lib name 'Srv_SetRWAreaCallback';
function Srv_ErrorText;               external simatic_lib name 'Srv_ErrorText';
function Srv_EventText;               external simatic_lib name 'Srv_EventText';
//******************************************************************************
//                              PARTNER FORWARDS
//******************************************************************************
function Par_Create;                  external simatic_lib name 'Par_Create';
procedure Par_Destroy;                external simatic_lib name 'Par_Destroy';
function Par_GetParam;                external simatic_lib name 'Par_GetParam';
function Par_SetParam;                external simatic_lib name 'Par_SetParam';
function Par_Start;                   external simatic_lib name 'Par_Start';
function Par_StartTo;                 external simatic_lib name 'Par_StartTo';
function Par_Stop;                    external simatic_lib name 'Par_Stop';
function Par_BSend;                   external simatic_lib name 'Par_BSend';
function Par_AsBSend;                 external simatic_lib name 'Par_AsBSend';
function Par_CheckAsBSendCompletion;  external simatic_lib name 'Par_CheckAsBSendCompletion';
function Par_WaitAsBSendCompletion;   external simatic_lib name 'Par_WaitAsBSendCompletion';
function Par_SetSendCallback;         external simatic_lib name 'Par_SetSendCallback';
function Par_BRecv;                   external simatic_lib name 'Par_BRecv';
function Par_CheckAsBRecvCompletion;  external simatic_lib name 'Par_CheckAsBRecvCompletion';
function Par_SetRecvCallback;         external simatic_lib name 'Par_SetRecvCallback';
function Par_GetTimes;                external simatic_lib name 'Par_GetTimes';
function Par_GetLastError;            external simatic_lib name 'Par_GetLastError';
function Par_GetStatus;               external simatic_lib name 'Par_GetStatus';
function Par_GetStats;                external simatic_lib name 'Par_GetStats';
function Par_ErrorText;               external simatic_lib name 'Par_ErrorText';
//******************************************************************************
